...
INSERT INTO kitchen_station (station_name, specialization, manager_id)
VALUES 
    ('Grill Station',  'Grilling', NULL),
    ('Pastry Station',  'Baking & Pastry', NULL),
    ('Sauce Station',  'Sauce Preparation', NULL),
    ('Fry Station',  'Frying', NULL),
    ('Garde Manger',  'Cold Dishes', NULL),
    ('Butchery Station',  'Meat Preparation', NULL),
    ('Fish Station',  'Seafood Preparation', NULL),
    ('Soup Station',  'Soups & Stews', NULL),
    ('Vegetable Station',  'Vegetable Preparation', NULL),
    ('Dessert Station',  'Desserts', NULL);
...
INSERT INTO customer_order (order_id, date, status, priority, customer_id, delivery_driver_id, payment_method)
VALUES 
    (1, '2024-12-18 09:30:00', 'Pending', 5, 1, 'D1', 'Debit Card'),
    (2, '2024-12-18 11:00:00', 'Completed', 8, 2, 'D2', 'Crypto'),
    (3, '2024-12-17 14:45:00', 'In Progress', 7, 3, 'D3', 'Cash'),
    (4, '2024-12-17 17:00:00', 'Cancelled', 4, 4, 'D4', 'Check'),
    (5, '2024-12-16 08:15:00', 'Pending', 6, 5, 'D5', 'Cash'),
    (6, '2024-12-16 13:00:00', 'Completed', 9, 6, 'D6', 'Cash' ),
    (7, '2024-12-15 15:30:00', 'In Progress', 3, 7, 'D7', 'Crypto'),
    (8, '2024-12-15 19:00:00', 'Pending', 2, 8, 'D8',' Credit Card'),
    (9, '2024-12-14 10:30:00', 'Completed', 10, 9, 'D9', 'Check'),
    (10, '2024-12-14 12:45:00', 'Cancelled', 1, 10, 'D10', 'Cash');
...
VALUES 
    ...
    (2, 'Ahmad Rami', 'Newly employed', 0, 'Tripoli, Coastal Avenue, Apt 15', 71123456, 'ahmad.rami@company.com'),
    ...
    (5, 'Rita Chidiac', 'Newly employed', 0, 'Jounieh, Beachfront Road, Building 4', 81123456, 'rita.chidiac@company.com'),
    ...
    (8, 'Jad Youssef', 'Newly employed', 0, 'Baalbek, Temple Road, Villa 9', 76123457, 'jad.youssef@company.com'),
...
-- Spaghetti Bolognese
INSERT INTO is_made_of (meal_id, ingredient_id, quantity)
VALUES
